...
import com.example.busmanagementapp.model.BusStation;

import java.util.List;

public class BusRepository implements CRUD<BusStation> {
    ...
    public boolean delete(String id) {
        return busStations.removeIf(entity -> entity.getId().equals(id));
    }
}
